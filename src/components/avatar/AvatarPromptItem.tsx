...
export const AvatarPromptItem = ({ item, file }: { item: Prompt, file: File | undefined }) => {
  ...
  return <div className="flex flex-1 flex-col gap-4 border-slate-500 border-1 p-8 rounded-lg min-w-[360px] max-w-[360px] text-black">
    ...
    <div className={'flex flex-col flex-wrap justify-center gap-2 items-center'}>
      ...
      {showPrompt ? <p className={'text-xl text-center text-white pt-4'}>{item.content}</p> : null}
